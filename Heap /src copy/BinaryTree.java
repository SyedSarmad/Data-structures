public class BinaryTree<T> implements BinaryTreeInterface<T>
{
     ...
     *     . In BinaryTree.java
     *          1. public void postorderTraverse(); COMPLETE
     *          2. private void postorderTraverse(BinaryNode<T> node) COMPLETE
    ...
    {
        BinaryNode<T> copyRoot = root.copy();
        copyRoot.postorderTraverse_binaryNodeMethod();
    ...
    private int getNumberOfNodes(BinaryNode<T> node)
    {
        ...
        if (root.getLeftChild() != null)
            leftNumber = root.getLeftChild().getNumberOfNodes_binaryNodeMethod();
        if (root.getRightChild() != null)
            rightNumber = root.getRightChild().getNumberOfNodes_binaryNodeMethod();
